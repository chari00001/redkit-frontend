...
const SearchResults = () => {
  ...
  const fetchSearchResults = async () => {
    ...
    try {
      ...
      if (results) {
        setFilteredCommunities(results.communities || []);
      ...
      setError(
        "Arama sonuçları getirilirken bir hata oluştu. Lütfen daha sonra tekrar deneyin."
      );
  ...
  useEffect(() => {
    ...
    // Arama terimi varsa, sonuçları getir
    ...
    <div className="space-y-6">
      {isLoading ? (
        <motion.div
          ...
          animate={{ opacity: 1 }}
        >
          <div className="mx-auto w-12 h-12 border-4 border-t-accent border-accent/20 rounded-full animate-spin mb-6"></div>
          <h2 className="text-2xl font-semibold text-gray-900 mb-3">
            Arama yapılıyor...
          </h2>
          <p className="text-gray-600 max-w-md mx-auto">
            "{searchQuery}" için sonuçlar getiriliyor
          </p>
        </motion.div>
      ) : error ? (
        <motion.div
